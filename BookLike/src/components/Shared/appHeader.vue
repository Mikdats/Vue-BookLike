    ...
    <nav class="flex w-full px-2">
      ...
      <div v-if="_isAuthenticated" class="ml-auto flex items-center">
        ...
        <div class="relative group">
          <button @click="" class="w-8 h-8 flex items-center justify-center rounded-md transition-colors duration-500 hover:bg-gray-200 group-focus-within:bg-gray-300">
